...
namespace HW_13_02
{
    class MotoArray : IMotorcycleRepository<Motorcycle>
    {
        ...
        {
            _ = motoArray.Where(_ => _ != null && _.Name == name) == null;
        }

        public void DeleteMotorcycleByID(int id)
        {
            _ = motoArray.Where(_ => _ != null && _.ID == id) == null;
        }

        public void GetMotorcycleByID(int id)
        {
            var result = motoArray.First(_ => _ != null && _.ID == id);
        ...
        public void UpdateMotorcycleByID(int id)
        {
            ...
            var result = motoArray.FirstOrDefault(_ => _ != null && _.ID == id);
            if (result != null)
            {
